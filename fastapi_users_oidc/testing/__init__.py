"""Testing utilities for apps using fastapi-users-oidc."""
...
class TestClient(AsyncClient):
    ...
    Usage::
        ...
        # Admin request
        response = await client.with_user(admin).post("/admin", json={})
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._access_token_model = access_token_model
        self._auth_user = None
        self._auth_token: str | None = None

    def with_user(self, user) -> "TestClient":
        """
        Return a client authenticated as the given user.

        Creates an access token for the user and sets the Authorization
        header. The token is created lazily on first request.
        """
    ...
    async def _ensure_auth_token(self) -> None:
        ...
        if self._auth_token is None:
            ...
            access_token = self._access_token_model(
